...
class SystemConfiguration:
    ...
    def from_json(json_dict: dict) -> "SystemConfiguration":
        ...
        return SystemConfiguration(
            bootstrap=BootstrapConfiguration.from_json(
                json_dict.get(BootstrapConfiguration.get_key(), {})
            ),
            client_server=ClientServerConfiguration.from_json(
                json_dict.get(ClientServerConfiguration.get_key(), {})
            ),
            app_server=AppServerConfiguration.from_json(
                json_dict.get(AppServerConfiguration.get_key(), {})
            ),
            app_builder=AppBuilderConfiguration.from_json(
                json_dict.get(AppBuilderConfiguration.get_key(), {})
            ),
            app_common=AppCommonConfiguration.from_json(
                json_dict.get(AppCommonConfiguration.get_key(), {})
            ),
        )
