...
@dataclass
class TestSummaryEvent(BaseEvent):
    """
    Event emitted with summary of all tests.

    :ivar total: Total number of tests
    :ivar passed: Number of tests that passed
    :ivar failed: Number of tests that failed
    """

    total: int = 0
    passed: int = 0
    failed: int = 0
    event_type: str = "TestSummaryEvent"
