...
declare module "./" {
    export interface pyBaseExceptionConstructor
        extends pyType<pyBaseException> {
    ...
    export interface pyKeyboardInterruptConstructor
        extends pyType<pyKeyboardInterrupt> {
    ...
    export interface pyGeneratorExitConstructor
        extends pyType<pyGeneratorExit> {
    ...
    export interface pyStopIterationConstructor
        extends pyType<pyStopIteration> {
    ...
    export interface pyStopAsyncIterationConstructor
        extends pyType<pyStopAsyncIteration> {
    ...
    export interface pyArithmeticErrorConstructor
        extends pyType<pyArithmeticError> {
    ...
    export interface pyFloatingPointErrorConstructor
        extends pyType<pyFloatingPointError> {
    ...
    export interface pyOverflowErrorConstructor
        extends pyType<pyOverflowError> {
    ...
    export interface pyZeroDivisionErrorConstructor
        extends pyType<pyZeroDivisionError> {
    ...
    export interface pyAssertionErrorConstructor
        extends pyType<pyAssertionError> {
    ...
    export interface pyAttributeErrorConstructor
        extends pyType<pyAttributeError> {
    ...
    export interface pyModuleNotFoundErrorConstructor
        extends pyType<pyModuleNotFoundError> {
    ...
    export interface pyUnboundLocalErrorConstructor
        extends pyType<pyUnboundLocalError> {
    ...
    export interface pyFileNotFoundErrorConstructor
        extends pyType<pyFileNotFoundError> {
    ...
    export interface pyReferenceErrorConstructor
        extends pyType<pyReferenceError> {
    ...
    export interface pyNotImplementedErrorConstructor
        extends pyType<pyNotImplementedError> {
    ...
    export interface pyRecursionErrorConstructor
        extends pyType<pyRecursionError> {
    ...
    export interface pyIndentationErrorConstructor
        extends pyType<pyIndentationError> {
    ...
    export interface pyUnicodeDecodeErrorConstructor
        extends pyType<pyUnicodeDecodeError> {
    ...
    export interface pyUnicodeEncodeErrorConstructor
        extends pyType<pyUnicodeEncodeError> {
    ...
    export interface pyExternalErrorConstructor
        extends pyType<pyExternalError> {
