...
assert_equal(
    ...
    Page(state=State(), content=['You bought 5 apples, 7 oranges, 3 plums, and 7 pears. (oranges and pears and more) (test and test) (True) (False)']))

assert_equal(
    buy_page(State(), 5, 7, 100, '200', 'oranges and pears and more', 'test and test', False, True),
    Page(state=State(), content=['You bought 5 apples, 7 oranges, 200 plums, and 100 pears. (oranges and pears and more) (test and test) (False) (True)']))
