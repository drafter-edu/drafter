...
assert_equal(
    index(
        State(
            items=[
                Item(name="Sword", price=100, stock=3),
                    ...
                    Span(
                        content=[
                            ...
                            Button(
                                text="Sword",
                                url="/purchase",
                                arguments=Argument(name="name", value="Sword"),
                            ),
                    ...
                    Span(
                        content=[
                            ...
                            Button(
                                text="Shield",
                                url="/purchase",
                                arguments=Argument(name="name", value="Shield"),
                            ),
                    ...
                    Span(
                        content=[
                            ...
                            Button(
                                text="Potion",
                                url="/purchase",
                                arguments=Argument(name="name", value="Potion"),
                            ),
...
start_server(
    State(
        [Item("Sword", 100, 3), Item("Shield", 50, 5), Item("Potion", 25, 10)], [], 200
    )
)
