...
def show_chat(state: AppState) -> Page:
...
@route
def chat(state: AppState, api_key: str, service: str) -> Page:
...
@route
def send_message(state: AppState, user_message: str) -> Page:
...
@route
def clear_conversation(state: AppState) -> Page:
...
@route
def reset_api_key(state: AppState) -> Page:
