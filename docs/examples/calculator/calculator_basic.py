...
assert_equal(
    ...
    Page(
        state=State(first_number="5", second_number="3", result="8"),
        content=[
            "What is the first number?",
...
# Copying the body generated from the page may introduce them!
assert_equal(
    add_page(State("0", "0", ""), "five", "three"),
    Page(
        state=State(
            first_number="five", second_number="three", result="Invalid numbers!"
        ),
        content=[
            "What is the first number?",
