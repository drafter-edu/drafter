...
[https://drafter-edu.github.io/examples/store/](https://drafter-edu.github.io/examples/store/)
...
**Step 1: Download** `store.py` from `docsrc/workbook/part4/store.py` and put it into an appropriate directory,
