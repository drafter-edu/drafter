...
If you visit the url [http://localhost:8080/ ](http://localhost:8080/) then you will see a page like this:

![Simple website with the text "Hello World!" and "Welcome to Drafter" along with some more information further below.](quickstart_empty_site.png)
...
![Simple website with the text "The message is" and "The original message" along with some more information further below.](quickstart_simple_state.png)
...
![Clickable button is now visible on the original page](quickstart_button_state_1.png)

Once we click the button, we are taken to the new page.

![Clickable button was added on the first page that leads to this new page.](quickstart_button_state_2.png)
...
![A textfield with a save button next to it](quickstart_string_state.png)
...
![The page content expandable](quickstart_copy_page_content.png)
...
Check out the documentation of Components  to see all that you can
add to your website!

And if you want a longer example, check out the [calculator example ](../examples/calculator.md) to see a more complicated web application.
