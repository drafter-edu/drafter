...
Drafter can be installed through the Integrated Development Environment (IDE) [Thonny](https://thonny.org/) in two ways:
...
Check out Drafter quick start [quickstart].

## Command Line

Drafter can also be installed straight from the command line through `pip install drafter`.

It can also be installed on a [Python virtual environment](https://realpython.com/python-virtual-environments-a-primer/).
