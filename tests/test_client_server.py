...
class TestPayloadHandling:
    ...
    def test_verify_payload_invalid_type(
        self, started_server: ClientServer, sample_request: Request
    ):
    ...
    def test_get_messages_from_payload(
        self, started_server: ClientServer, sample_request: Request
    ):
    ...
    def test_get_target_from_payload(
        self, started_server: ClientServer, sample_request: Request
    ):
...
class TestStateManagement:
    ...
    def test_handle_state_updates_no_update(
        self, started_server: ClientServer, sample_request: Request
    ):
    ...
    def test_handle_state_updates_with_update(
        self, started_server: ClientServer, sample_request: Request
    ):
...
class TestErrorHandling:
    ...
    def test_make_error_response(
        ...
        error = ErrorDetails(
            id="system.test_error",
            category=CATEGORY_SYSTEM,
            message="Test error message",
            details="Test details",
            status_code=STATUS_ERROR,
            context=Correlation(
                route=sample_request.url, request_id=sample_request.id, phase="visit"
            ),
        )

        response = started_server.make_error_response(sample_request, error)
