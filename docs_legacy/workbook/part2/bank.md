...
Preview this website at <https://drafter-edu.github.io/examples/bank/>.

[https://drafter-edu.github.io/examples/bank/](https://drafter-edu.github.io/examples/bank/)

![Screenshot of the Bank Account application](drafter_preview.png)

**Step 1: Download** `bank.py` from `docsrc/workbook/part2/bank.py` and put it into the same directory as the cookie clicker game.
