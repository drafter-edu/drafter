...
Preview this website at <https://drafter-edu.github.io/examples/adventure/>.

[https://drafter-edu.github.io/examples/adventure/](https://drafter-edu.github.io/examples/adventure/)

![Screenshot of the Simple Adventure Game](screen_shots.png)

**Step 1: Download** the images and the starting file for the game from the following links:

* `adventure.py` from `docsrc/workbook/part3/adventure.py`
* `field.png` from `docsrc/workbook/part3/field.png`
* `woods.png` from `docsrc/workbook/part3/woods.png`
* `cave.png` from `docsrc/workbook/part3/cave.png`
* `victory.png` from `docsrc/workbook/part3/victory.png`
