...
Preview the activity at <https://drafter-edu.github.io/examples/cookie/>.

[https://drafter-edu.github.io/examples/cookie/](https://drafter-edu.github.io/examples/cookie/)

![Screenshot of the Cookie Clicker game](cookie.png)

**Step 1: Download** `cookie.py` from `docsrc/workbook/part1/cookie.py` and put it into an appropriate directory, where you will place all the other files
for this workbook.
...
![Screenshot of failing test for the Cookie Clicker game](cookie_test.png)
