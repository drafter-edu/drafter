...
class Server:
    ...
    def make_bottle_page(self, original_function: Callable[..., Page]) -> Callable[..., Page]:
        """
        ...
        def bottle_page(*args: Any, **kwargs: Any) -> Page:
            # TODO: Handle non-bottle backends
...
def get_all_routes(server: Optional[Server] = None) -> dict[str, Callable[..., Page]]:
    """
